...
<html>
<head>
	<title>Gestión de Flotilla | Choferes</title>
	<meta charset="UTF-8">
            	...
            	<main>
            	    <div class="row mb-1">
                        ...
                        <div class="col-1 text-end">
                            <button type="button" class="btn btn-primary mx-2" data-bs-toggle="modal" data-bs-target="#modal_Choferes">Nuevo Chofer</button>
                        </div>    
                        <div class="col-7">
